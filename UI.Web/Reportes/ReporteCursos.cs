...
{
  public class ReporteCursos : Report
  {
    ...
    protected override object CalcExpression(string expression, Variant Value)
    {
      if (expression == "Especialidad")
        return Especialidad;
      if (expression == "Materia")
        return Materia;
      if (expression == "Comision")
        return Comision;
      return null;
    }
    ...
    private void InitializeComponent()
    {
      ...
      reportString += "ad:\" Font=\"Arial, 10pt, style=Bold\"/>\r\n      <TextObject Name=\"txtEspecialidad\" " +
        "Left=\"103.95\" Top=\"66.15\" Width=\"604.8\" Height=\"18.9\" Text=\"[Especialidad]\" Font" +
        "=\"Arial, 10pt\"/>\r\n      <TextObject Name=\"Text1\" Left=\"-9450\" Top=\"-9450\" Width=" +
        "\"94.5\" Height=\"18.9\" HorzAlign=\"Center\" Font=\"Arial, 10pt\"/>\r\n      <TextObject " +
        "Name=\"Text3\" Left=\"18.9\" Top=\"94.5\" Width=\"94.5\" Height=\"18.9\" Text=\"Materia:\" F" +
        "ont=\"Arial, 10pt, style=Bold\"/>\r\n      <TextObject Name=\"Text4\" Left=\"103.95\" To" +
        "p=\"94.5\" Width=\"633.15\" Height=\"18.9\" Text=\"[Materia]\" Font=\"Arial, 10pt\"/>\r\n   " +
        "   <TextObject Name=\"Text5\" Left=\"18.9\" Top=\"122.85\" Width=\"94.5\" Height=\"18.9\" " +
